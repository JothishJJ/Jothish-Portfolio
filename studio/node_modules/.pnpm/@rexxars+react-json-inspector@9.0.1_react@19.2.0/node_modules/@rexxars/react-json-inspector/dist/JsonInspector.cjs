...
var jsxRuntime = require("react/jsx-runtime"), react = require("react"), debounce = require("debounce"), md5OMatic = require("md5-o-matic");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var debounce__default = /* @__PURE__ */ _interopDefaultCompat(debounce), md5OMatic__default = /* @__PURE__ */ _interopDefaultCompat(md5OMatic);
...
class Highlighter extends react.Component {
  ...
  render() {
    ...
    if (!highlight || highlightStart === -1)
      return /* @__PURE__ */ jsxRuntime.jsx("span", { children: str });
    const highlightLength = highlight.source.length, highlightString = str.slice(
      highlightStart,
      highlightStart + highlightLength
    );
    return /* @__PURE__ */ jsxRuntime.jsx("span", { children: str.split(highlight).map(function(part, index) {
      return /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
        index > 0 ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "json-inspector__hl", children: highlightString }) : null,
        part
      ] }, index);
    }) });
  }
...
class Leaf extends react.Component {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            "label",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "json-inspector__flatpath", children: d.path }),
                /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "json-inspector__key", children: [
                  this.format(d.key),
                  ":",
  ...
  renderTitle() {
    ...
    if (Array.isArray(data)) {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "json-inspector__value json-inspector__value_helper", children: [
        length > 0 ? "[\u2026] " : "[] ",
        items(length)
      ] });
    }
  ...
  renderShowOriginalButton() {
    ...
    return isPrimitive(data) || this.state.original || !getOriginal || !query || query.test(this.keypath()) ? null : /* @__PURE__ */ jsxRuntime.jsx(
      "span",
      {
  ...
  renderInteractiveLabel(originalValue, isKey) {
    ...
    return typeof InteractiveLabel == "function" ? /* @__PURE__ */ jsxRuntime.jsx(
      InteractiveLabel,
      {
  ...
  format(str) {
    return /* @__PURE__ */ jsxRuntime.jsx(Highlighter, { string: str, highlight: this.props.query });
  }
  getClassName() {
...
function getLeafKey(key, value) {
  if (isPrimitive(value)) {
    const hash = md5OMatic__default.default(String(value));
    return key + ":" + hash;
  } else
...
class JsonInspector extends react.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          this.renderToolbar(),
          isNotFound ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "json-inspector__not-found", children: "Nothing found" }) : /* @__PURE__ */ jsxRuntime.jsx(
            Leaf,
            {
              data,
              onClick,
  ...
  renderToolbar() {
    ...
    return Search ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "json-inspector__toolbar", children: /* @__PURE__ */ jsxRuntime.jsx(
      Search,
      {
        onChange: debounce__default.default(
          this.search,
...
exports.JsonInspector = JsonInspector;
//# sourceMappingURL=JsonInspector.cjs.map
