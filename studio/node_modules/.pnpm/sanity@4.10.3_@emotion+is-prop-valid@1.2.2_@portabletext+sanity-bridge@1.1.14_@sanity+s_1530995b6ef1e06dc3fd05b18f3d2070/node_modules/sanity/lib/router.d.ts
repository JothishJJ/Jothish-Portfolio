 ...
 * @public
 */
declare interface NavigateBaseOptions_2 {
  replace?: boolean
}
 ...
 * @public
 */
declare interface NavigateOptions_2 extends NavigateBaseOptions_2 {
  stickyParams?: Record<string, string | undefined | null>
}
 ...
 * @internal
 */
export declare const RouterContext: Context<RouterContextValue_2 | null>
 ...
 * @public
 */
declare interface RouterContextValue_2 {
  /**
   * Resolves the path from the given router state. See {@link RouterState}
   *
   * When state is null, it will resolve the path from the current state
   ...
   */
  navigateStickyParams: (
    params: NavigateOptions_2['stickyParams'],
    options?: NavigateBaseOptions_2,
  ) => void
  /**
   * Updates the router state and navigates to a new path.
   * Allows specifying new state values and optionally merging sticky parameters.
   ...
   */
  navigate: {
    (nextState: RouterState_2, options?: NavigateOptions_2): void
    (
      options: NavigateOptions_2 & {
