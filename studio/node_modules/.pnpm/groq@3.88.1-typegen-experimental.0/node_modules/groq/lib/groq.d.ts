 ...
 * @public
 */
export declare function defineProjection<const TProjection extends string>(
 ...
 * @public
 */
export declare function defineQuery<const TQuery extends string>(query: TQuery): TQuery
 ...
 * @public
 */
export declare type PickProjectionResult<
  T,
  TProjectionBaseTypeName extends string = string,
> = Extract<T, ProjectionBase<T, TProjectionBaseTypeName>>
 ...
 * @public
 */
export declare type PickSchema<T, TSchemaId extends string = string> = Extract<
  T,
 ...
 * @public
 */
export declare type ProjectionBase<TBase, TProjectionBaseTypeName extends string> = TBase & {
  /**
   * @internal
...
declare type SafeAccess<T, K extends string> = K extends keyof T ? T[K] : T[keyof T]
...
declare interface _SanityDocument {
  _id: string
  _type: string
  _createdAt: string
  _updatedAt: string
 ...
 * @public
 */
export declare type SanityProjectionResult<
 ...
 * @public
 */
export declare interface SanityProjections {}
 ...
 * @public
 */
export declare type SanityQueryResult<
 ...
 * @public
 */
export declare type SanitySchema<TSchemaId extends string = string> = PickSchema<
 ...
 * @public
 */
export declare interface SanitySchemas {}
 ...
 * @public
 */
export declare type SanitySchemaType<
  TSchemaTypeName extends string = string,
  TSchemaId extends string = string,
> = Extract<
  SanitySchema<TSchemaId>,
  {
 ...
 * @public
 */
export declare type SchemaOrigin<TBase, TSchemaId extends string> = TBase & {
  /**
   * @internal
   * @deprecated typescript helper only
   */
